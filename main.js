...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const hotspotData = {
    1: {
      num: '01',
      title: 'Принтер ZEBRA ZD410',
      desc: 'Предназначен для автоматической печати маркировочных этикеток. Принтер интегрирован с ПЛК Siemens S7-1500 и получает данные для печати по сети, обеспечивая оперативное формирование и нанесение этикеток в составе технологического цикла станции.',
      specs: []
    },
    2: {
      num: '02',
      title: 'Конвейерный модуль',
      desc: 'Обеспечивает автоматическое перемещение заготовок между технологическими позициями станции. Его использование позволяет организовать непрерывную подачу изделий в зону маркировки и повысить эффективность выполнения производственного цикла.',
      specs: []
    },
    3: {
      num: '03',
      title: 'Блок подготовки сжатого воздуха',
      desc: 'Предназначен для очистки, регулирования и подачи воздуха к пневматическим исполнительным механизмам станции. Он обеспечивает стабильную работу пневмосистемы, поддерживая необходимое давление для корректного выполнения технологических операций.',
      specs: []
    },
    4: {
      num: '04',
      title: 'Интерфейсная плата ввода-вывода',
      desc: 'Обеспечивает распределение питания 24 В DC, подключение датчиков, исполнительных устройств и индикацию состояния сигналов.',
      specs: []
    },
    5: {
      num: '05',
      title: 'Пульт управления станции',
      desc: 'Обеспечивает запуск и остановку технологического цикла, выбор режима работы, сброс аварийных состояний и визуальную индикацию текущего состояния оборудования.',
      specs: []
    },
    6: {
      num: '06',
      title: 'Распределительный модуль',
      desc: 'Предназначен для управления материальным потоком на конвейерной линии. Его основная функция заключается в физическом изъятии, разделении или перенаправлении заготовок по результатам контроля их параметров.',
      specs: []
    }
  };
